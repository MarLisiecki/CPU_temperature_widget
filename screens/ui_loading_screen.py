...
class Ui_LoadingScreen(object):
    ...
    def retranslateUi(self, LoadingScreen):
        ...
        self.title.setText(QCoreApplication.translate("LoadingScreen", u"CPU", None))
        self.loading.setText(QCoreApplication.translate("LoadingScreen", u"Real time", None))
        self.example.setText(QCoreApplication.translate("LoadingScreen", u"CPU Package", None))
